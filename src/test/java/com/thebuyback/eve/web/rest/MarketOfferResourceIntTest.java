...
public class MarketOfferResourceIntTest {
    ...
    private static final String DEFAULT_APPRAISAL_LINK = "AAAAAAAAAA";
    private static final String UPDATED_APPRAISAL_LINK = "BBBBBBBBBB";
    ...
    public static MarketOffer createEntity() {
        MarketOffer marketOffer = new MarketOffer()
            ...
            .text(DEFAULT_TEXT)
            .appraisalLink(DEFAULT_APPRAISAL_LINK);
        return marketOffer;
    }
    ...
    public void createMarketOffer() throws Exception {
        ...
        assertThat(testMarketOffer.getIssuer()).isEqualTo(DEFAULT_ISSUER);
        assertThat(testMarketOffer.getCreated()).isEqualTo(DEFAULT_CREATED);
        assertThat(testMarketOffer.getExpiry()).isEqualTo(DEFAULT_EXPIRY);
        assertThat(testMarketOffer.getExpiryUpdated()).isEqualTo(DEFAULT_EXPIRY_UPDATED);
        assertThat(testMarketOffer.getType()).isEqualTo(DEFAULT_TYPE);
        assertThat(testMarketOffer.getCategory()).isEqualTo(DEFAULT_CATEGORY);
        ...
        assertThat(testMarketOffer.getAppraisalLink()).isEqualTo(DEFAULT_APPRAISAL_LINK);
    }
    ...
    public void getAllMarketOffers() throws Exception {
        ...
        restMarketOfferMockMvc.perform(get("/api/market-offers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].appraisalLink").value(hasItem(DEFAULT_APPRAISAL_LINK.toString())));
    }
    ...
    public void getMarketOffer() throws Exception {
        ...
        restMarketOfferMockMvc.perform(get("/api/market-offers/{id}", marketOffer.getId()))
            ...
            .andExpect(jsonPath("$.appraisalLink").value(DEFAULT_APPRAISAL_LINK.toString()));
    }
    ...
    public void updateMarketOffer() throws Exception {
        ...
        updatedMarketOffer
            ...
            .text(UPDATED_TEXT)
            .appraisalLink(UPDATED_APPRAISAL_LINK);
        ...
        assertThat(testMarketOffer.getAppraisalLink()).isEqualTo(UPDATED_APPRAISAL_LINK);
    }
